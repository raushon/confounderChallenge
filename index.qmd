...
# Create figure with object-oriented style
...
ax.text(len(patients_df) * 0.97, dreamy_mean, f'○ {dreamy_mean:.2f}',
        fontsize=12, color='#4E79A7', ha='right', va='bottom',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#4E79A7', linewidth=1.5),
        zorder=4)
ax.text(len(patients_df) * 0.97, duck_mean, f'△ {duck_mean:.2f}',
        fontsize=12, color='#E15759', ha='right', va='top',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#E15759', linewidth=1.5),
        zorder=4)
...
y_min = min(patients_df['post_surgical_score'].min(), duck_mean, dreamy_mean) - 0.5
y_max = max(patients_df['post_surgical_score'].max(), duck_mean, dreamy_mean) + 0.5
...
# Add text annotations with shape symbols
ax.text(len(patients_randomized_df) * 0.97, dreamy_mean, f'○ {dreamy_mean:.2f}',
        fontsize=12, color='#4E79A7', ha='right', va='bottom',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#4E79A7', linewidth=1.5),
        zorder=4)
ax.text(len(patients_randomized_df) * 0.97, duck_mean, f'△ {duck_mean:.2f}',
        fontsize=12, color='#E15759', ha='right', va='top',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#E15759', linewidth=1.5),
        zorder=4)
...
y_min = min(patients_randomized_df['post_surgical_score'].min(), duck_mean, dreamy_mean) - 0.5
y_max = max(patients_randomized_df['post_surgical_score'].max(), duck_mean, dreamy_mean) + 0.5
ax.set_ylim(y_min, y_max)
...
# Add shaded region highlighting severity between -1 and 1 (do this first so it's behind everything)
...
# Add text annotations with shape symbols (position at right edge of severity range)
severity_max = patients_df['severity'].max()
ax.text(severity_max * 0.97, dreamy_mean, f'○ {dreamy_mean:.2f}',
        fontsize=12, color='#4E79A7', ha='right', va='bottom',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#4E79A7', linewidth=1.5),
        zorder=4)
ax.text(severity_max * 0.97, duck_mean, f'△ {duck_mean:.2f}',
        fontsize=12, color='#E15759', ha='right', va='top',
        bbox=dict(boxstyle='round,pad=0.5', facecolor='white', alpha=0.8, edgecolor='#E15759', linewidth=1.5),
        zorder=4)
